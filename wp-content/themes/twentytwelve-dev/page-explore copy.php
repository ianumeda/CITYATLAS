			  ...
			  return String.fromCharCode(codePt);
				...
				var todaydata = <?php echo json_encode($todaydata); ?>;
				    ...
				    for (var i = 0; i < xdata.length; i++) {
						...
						if(todaydata[i]==1) { var marker = L.marker([n[0],n[1]], {icon: this['markergreen'+markerid]}).addTo(map); }
						else if(todaydata[i]==2) { var marker = L.marker([n[0],n[1]], {icon: this['markergreeninverse'+markerid]}).addTo(map); }
						else if(todaydata[i]==-1) { var marker = L.marker([n[0],n[1]], {icon: this['markergrey'+markerid]}).addTo(map); }
						else { var marker = L.marker([n[0],n[1]], {icon: this['markerblue'+markerid]}).addTo(map); }
