			...
			<span class='tribe-events-calendar-buttons'> 
				...
				<?php
						$terms = get_terms("tribe_events_cat");
				 		...
				 		if ( $count > 0 ){
				 		    echo "<ul>";
							echo "<li class='cat_all'><a href='". home_url("/events/month/") ."'>All</a></li>";
				 		    foreach ( $terms as $term ) {
				 		      echo "<li class='cat_". $term->slug ."'><a href='". home_url("/events/category/". $term->slug ."/month/") ."'>" . $term->name . "</a></li>";
