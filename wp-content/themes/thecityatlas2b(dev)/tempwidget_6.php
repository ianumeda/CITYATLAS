<?php
// City Atlas Temperature Widget version 1.6
$city='newyork'; // get city name for db table reference
...
echo "Today in $prettycity: <span class='high'>". getF($thedata['forecast'][0]) ."&deg;F</span><br/>Average Since ". getEarliestDataYear($city) .": <span class='high'>". getF($thedata['historicalaverage'][0]) ."&deg;F</span>";
?>