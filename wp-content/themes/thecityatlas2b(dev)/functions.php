...
function twentyten_continue_reading_link() {
	return '<span class="more-link"> <a href="'. get_permalink() . '">' . __( '<span class="more-link">Continue reading </span><span class="meta-nav">&rarr;</span>', 'twentyten' ) . '</a></span>';
}
...
function twentyten_widgets_init() {
	...
	register_sidebar(array('name'=>'Lifestyle1',));
	register_sidebar(array('name'=>'Lab Sidebar',));
	register_sidebar(array('name'=>'Micro Textile Lab',));
	register_sidebar(array('name'=>'Field Lab',));
...
function get_ngg_image_dimensions($imageID){
	...
	// $foo = nggdb::find_image($imageID);
	if($foo){
		// $aDimensions[0]=nggGallery::i18n($foo->width);
		// $aDimensions[1]=nggGallery::i18n($foo->height);
