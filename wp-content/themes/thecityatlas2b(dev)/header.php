...
<div id='fixedfooter'>
	...
	<div id="bottom-logo"><a href="<?php echo home_url('/'); ?>">City Atlas</a></div><div id="bottom-logo-beta"><a href="<?php echo home_url('/beta-testing-feedback/'); ?>">[BETA]</a></div><!-- #bottom-logo -->
				<ul id="" class="" style="float:left; margin-left:20px;">
					...
					<?php echo get_menu_item(42, "LAB", "atlas-lab", array('queryArgs'=>array('tax_query' => array('relation' => 'OR', array( 'taxonomy' => 'category', 'field' => 'slug', 'terms' => array( 'brownfield-remediation','micro-textile-lab-blog' ) ) ) ),  'numberPosts'=>3, 'maxColumns'=>3, 'maxRows'=>1, 'totalWidth'=>960, 'margins'=>array(0,10,6,0), 'padding'=>array(4), 'gridElementHeight'=>130, 'textSpace'=>array(230,60), 'imagePosition'=>'left', 'gridElementBorder'=>1, 'hasInfoTab'=>false, 'useEmphasis'=>TRUE, 'textOptions'=>array('title'=>array('style'=>'h2','link'=>'yes please'), 'excerpt'=>array('style'=>'p', 'maxlength'=>50)) ) ); ?>
