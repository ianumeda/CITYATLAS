...
if(function_exists('gigya_signup_page')) {
	...
	act.setTitle("City Atlas New York");
	act.setLinkBack("'. home_url( '/' ) .'");
	act.setDescription("'. esc_attr( get_bloginfo( 'description', 'display' ) ) .'");
	act.addActionLink("Your guide to sustainable living", "'. home_url('/') .'");
	act.addMediaItem({ type: "image", src: "http://thecityatlas.org/wp-content/themes/images/thecityatlaslogo-nocity.png", href: "'. home_url('/') .'" });
