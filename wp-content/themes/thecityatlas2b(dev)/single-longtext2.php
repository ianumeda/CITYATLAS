<?php
/*
Template Name Posts: long-text-with-images-and-pullquotes(2)
*/
/**
...
?>
<div id="lead-wrap">		
	<div id="fullscreen-lead" onClick="goToByScroll('lahg-center')" style="background: url(<?php echo $theBGurl; ?>) no-repeat center center scroll; -webkit-background-size: cover; moz-background-size: cover; o-background-size: cover; background-size: cover;">
		<div id="lead-text">
			<a href="#article"><h1 class="post-title"><?php the_title(); ?></h1>
			<?php if( $sCustomSubtitle=get_post_meta($post->ID,"subtitle",true) ) echo '<h2 class="post-subtitle">'.$sCustomSubtitle.'</h2>'; ?><h2 class="post-subsubtitle">(click to go to article)</h2></a>
		</div><!-- #lead-text -->
	</div><!-- #fullscreen-lead -->
</div><!-- #lead-wrap -->
<?php } ?>
...
<div id="lahg2col-container">
	<div id="lahg-center" class="column">
			...
			<div id="post-head" >
				...
				<div id="post-body" class="long-text long-text-body">
					<?PHP
