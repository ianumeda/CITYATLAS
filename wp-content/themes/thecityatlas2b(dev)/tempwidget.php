...
echo "<a href='". $widgetlink ."'>Today in $city: <span class='high'>". getF($thedata['forecast'][0]) ."&deg;F</span><br/>Average Since 1950: <span class='high'>". getF($thedata['historicalaverage'][0]) ."&deg;F</span><span class='infobutton'>i</span></a>";
?>