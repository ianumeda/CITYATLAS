<?php
// City Atlas Temperature Widget version 1.7.1
...
function getTimezone($city){
	...
	elseif($city=='montreal') return 'America/Montreal';
...
function getWundergroundCityQuery($city){
	...
	if($city=='montreal') return 'Canada/Montreal';
...
function getTempFormatForCity($city,$temp){
	$Ccities=array('montreal','barcelona','paris','london','kolkata');
...
if(strtolower($prettycity)=='sf bay') $prettycity='San Francisco';

echo "Today in $prettycity: <span class='high'>". getTempFormatForCity($city,$thedata['forecast'][0]) ."</span><br/>Average Since 1950: <span class='high'>". getTempFormatForCity($city,$thedata['historicalaverage'][0]) ."</span>";
//echo "Today in $prettycity: <span class='high'>". getTempFormatForCity($city,$thedata['forecast'][0]) ."</span><br/>Average Since ". getEarliestDataYear($city) .": <span class='high'>". getTempFormatForCity($city,$thedata['historicalaverage'][0]) ."</span>";
?>