...
?>
<div id="tribe-events-content" class="upcoming" style="width:960px; margin:0 auto;">
	...
	<?php if(!tribe_is_day()): // day view doesn't have a grid ?>
		...
		<span class='tribe-events-calendar-buttons'> 
			...
			<span class="event-category-menu">
			<?php
					$terms = get_terms("tribe_events_cat");
			 		$count = count($terms);
			 		if ( $count > 0 ){
			 		    echo "<ul>";
						echo "<li class='cat_all'><a href='". home_url("/events/month/") ."'>All Events</a></li>";
			 		    foreach ( $terms as $term ) {
			 		      echo "<li class='cat_". $term->slug ."'><a href='". home_url("/events/category/". $term->slug ."/upcoming/") ."'>" . $term->name . "</a></li>";
