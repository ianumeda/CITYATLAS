		...
		<div id="lahg2col-container">
			<div id="lahg-center" class="column">
					...
					<div id="post-wrap" >
						...
						<hr/>
						<h3><?php the_title(); ?> Blog</h3>
						<?php echo make_gridster(array('queryValue'=>array($labcategory[0]), 'gridElementBorder'=>1, 'maxColumns'=>1, 'gridElementHeight'=>240, 'flexibleHeight'=>TRUE,'totalWidth'=>640, 'margins'=>4, 'padding'=>6, 'hasInfoTab'=>FALSE, 'imagePosition'=>'left', 'smartImagePlacement'=>FALSE, 'textSpace'=>array(400,240), 'textOptions'=>array('date','title','excerpt'), 'useEmphasis'=>FALSE, 'morelink'=>'http://newyork.thecityatlas.org/category/micro-textile-lab-blog/page/2/', 'numberPosts'=>10 )); ?>
						<?php endif; ?>
				...
				<div id="lahg-right" class="column sidebar-border-right">
					<div id="post-sidebar" >
						...
						<?php if ( function_exists('dynamic_sidebar') && dynamic_sidebar('Textile Lab') ) : ?>
						<?php endif; ?>
						<div class='clear'>&nbsp</div>
						</div><!--.sidebar-element-->
					</div><!-- #post-sidebar -->
