...
get_header(); ?>
		...
		<div id="primary" class="showcase">
			<div id="content" role="main">
				...
				<div class="logo"><a href="<?php echo home_url( '/about/' ); ?>"><img src="<?php bloginfo('stylesheet_directory'); ?>/images/thecityatlaslogo-nocity.png" width="260" height="314" alt="<?php bloginfo( 'name' ); ?>"></a></div>
