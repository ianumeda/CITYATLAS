...
<span class='data'><span class='high'>". getF($thedata['forecast'][0]) ."&deg;F</span><br/><span class='comparison'>(".$comparison.")</span></span>
</span><!-- .concise -->
<span class='verbose'>
<span class='infobutton'>i</span>
<span class='words'>Today in $prettycity:<br/>Historical Avg:</span>
<span class='data'><span class='high'>". getF($thedata['forecast'][0]) ."&deg;F</span><br/><span class='high'>". getF($thedata['historicalaverage'][0]) ."&deg;F</span></span>
</span><!-- .verbose -->
</a>";
?>